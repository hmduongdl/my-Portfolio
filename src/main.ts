          ...
          <div class="grid md:grid-cols-[340px_1fr] lg:grid-cols-[400px_1fr] gap-10 md:gap-16 lg:gap-24 items-start">
            ...
            <div class="section-reveal bg-white/90 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg mt-4 md:mt-6 lg:mt-8 relative">
              ...
              <div class="hidden lg:flex flex-col gap-3 absolute left-2 top-20">
                <a href="https://facebook.com" target="_blank" class="w-10 h-10 rounded-full border-2 border-gray-300 hover:border-blue-600 hover:bg-blue-50 flex items-center justify-center transition-all group">
                ...
                <a href="https://github.com" target="_blank" class="w-10 h-10 rounded-full border-2 border-gray-300 hover:border-gray-900 hover:bg-gray-100 flex items-center justify-center transition-all group">
